    ...
    <>
      ...
      <div className="flex flex-col min-h-screen bg-white text-gray-900">
        ...
        >
          <div className="text-center">
            ...
            <p className="text-lg md:text-2xl mb-8 text-white">
              イメージ生成機能を活用して単語を簡単に暗記しよう
            </p>
            <a
              href="#about"
              className="inline-block px-6 py-3 text-lg font-bold bg-blue-600 text-white rounded-full hover:bg-blue-500 transition"
            >
              Learn More
            </a>
          </div>
        ...
        <section id="news" className="py-20 bg-gray-50">
          <div className="container mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-blue-900">
              NEWS<span className="block text-blue-600 text-lg">お知らせ</span>
            </h2>
            <div className="space-y-4 max-w-3xl mx-auto pl-8">
              <div className="flex items-center justify-between space-x-4">
                <p className="text-gray-600 text-left">2030.02.01</p>
                <span className="bg-gray-200 text-gray-600 rounded-full px-3 py-1">
                  お知らせ
                </span>
        ...
        <section id="about" className="py-20 bg-blue-50">
          <div className="container mx-auto flex flex-col md:flex-row items-center">
            ...
            <div className="md:w-1/2 text-center md:text-left md:pl-12 mt-8 md:mt-0">
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-blue-900">
                About
                <span className="block text-blue-600 text-lg">
                  アプリについて
                </span>
              </h2>
        ...
        <section id="features" className="py-20 bg-white">
          <div className="container mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-blue-900">
              Features<span className="block text-blue-600 text-lg">特徴</span>
            </h2>
        ...
        <section id="contact" className="py-20 bg-blue-50">
          <div className="container mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-blue-900">
              Contact
              <span className="block text-blue-600 text-lg">お問い合わせ</span>
            </h2>
            <form className="max-w-lg mx-auto space-y-6">
              <div className="text-left">
                <label
                  htmlFor="name"
                  className="block mb-2 font-bold text-blue-800"
                >
                  お名前
                </label>
                <input
                  ...
                  name="name"
                  required
                  className="w-full px-4 py-2 bg-white border border-blue-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
              <div className="text-left">
                <label
              ...
              <button
                type="submit"
                className="px-6 py-3 text-lg font-bold bg-blue-600 text-white rounded-full hover:bg-blue-500 transition"
              >
                送信する
              </button>
            </form>
