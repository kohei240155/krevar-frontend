    ...
    return (
        <div className="max-w-md mx-auto mt-10 p-6 bg-white rounded-lg shadow-md">
            ...
            <button
                ...
                className="w-full inline-flex items-center justify-center px-4 py-2 border-transparent text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 mt-4"
            >
                Delete
            </button>
        </div>
